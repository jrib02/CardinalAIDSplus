...
"}")
        ...
        self.logo.setPixmap(QtGui.QPixmap("CardinalAIDS4.jpg"))
...
"}")
        ...
        self.logoAdmin.setPixmap(QtGui.QPixmap("../../Downloads/CardinalAIDS4.jpg"))
...
"}")
        ...
        self.logo_3.setPixmap(QtGui.QPixmap("../../Downloads/CardinalAIDS4.jpg"))
